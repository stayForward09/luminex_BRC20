var tapscript = (function (t) {
  ...
  let f = class extends h {
    ...
    digestInto(t) {
      ...
      const { buffer: e, view: r, blockLen: n, isLE: s } = this;
      let { pos: o } = this;
      (e[o++] = 128),
  ...
  let y = class extends f {
      ...
      get() {
        const { A: t, B: e, C: r, D: n, E: s, F: i, G: o, H: a } = this;
      ...
      process(t, e) {
        ...
        let { A: r, B: n, C: s, D: i, E: o, F: a, G: u, H: h } = this;
        for (let t = 0; t < 64; t++) {
          const e =
              (h +
                (c(o, 6) ^ c(o, 11) ^ c(o, 25)) +
  ...
  function _(t, e = !1) {
    return e
      ? { h: Number(t & v), l: Number((t >> x) & v) }
      : { h: 0 | Number((t >> x) & v), l: 0 | Number(t & v) };
  }
  var E = {
    fromBig: _,
  ...
  let B = class extends f {
      ...
      process(t, e) {
        for (let r = 0; r < 16; r++, e += 4)
          (k[r] = t.getUint32(e)), (O[r] = t.getUint32((e += 4)));
        for (let t = 16; t < 80; t++) {
          const e = 0 | k[t - 15],
            r = 0 | O[t - 15],
        ...
        for (let t = 0; t < 80; t++) {
          const e =
              E.rotrSH(h, d, 14) ^ E.rotrSH(h, d, 18) ^ E.rotrBH(h, d, 41),
        ...
        ({ h: r, l: n } = E.add(0 | this.Ah, 0 | this.Al, 0 | r, 0 | n)),
          ({ h: s, l: i } = E.add(0 | this.Bh, 0 | this.Bl, 0 | s, 0 | i)),
          ({ h: o, l: a } = E.add(0 | this.Ch, 0 | this.Cl, 0 | o, 0 | a)),
          ({ h: c, l: u } = E.add(0 | this.Dh, 0 | this.Dl, 0 | c, 0 | u)),
          ({ h: h, l: d } = E.add(0 | this.Eh, 0 | this.El, 0 | h, 0 | d)),
          ({ h: f, l: l } = E.add(0 | this.Fh, 0 | this.Fl, 0 | f, 0 | l)),
          ({ h: p, l: g } = E.add(0 | this.Gh, 0 | this.Gl, 0 | p, 0 | g)),
          ({ h: m, l: y } = E.add(0 | this.Hh, 0 | this.Hl, 0 | m, 0 | y)),
          this.set(r, n, s, i, o, a, c, u, h, d, f, l, p, g, m, y);
      }
      roundClean() {
        k.fill(0), O.fill(0);
      }
  ...
  const C = new Uint8Array([
    ...
    L = Uint8Array.from({ length: 16 }, (t, e) => e),
    N = L.map((t) => (9 * t + 5) % 16);
  let H = [L],
    Z = [N];
  for (let t = 0; t < 4; t++)
    for (let e of [H, Z]) e.push(e[t].map((t) => C[t]));
  const R = [
  ...
  let V = class extends f {
    ...
    get() {
      const { h0: t, h1: e, h2: r, h3: n, h4: s } = this;
      return [t, e, r, n, s];
    }
    set(t, e, r, n, s) {
      (this.h0 = 0 | t),
  ...
  function X(t) {
    ...
    let r,
      n = 0;
    if (null !== t.match(/[^a-fA-f0-9]/))
      throw new TypeError("Invalid hex string: " + t);
    if (t.length % 2 > 0)
      throw new Error(`Hex string length is uneven: ${t.length}`);
    for (r = 0; r < t.length; r += 2)
      (e[n] = parseInt(t.slice(r, r + 2), 16)), (n += 1);
    return e;
  }
  function tt(t) {
  ...
  function st(t) {
    ...
    for (let r = 0; r < t.length; r++)
      e.push(t[r].toString(16).padStart(2, "0"));
    return e.join("");
  }
  function it(t) {
    let e,
  ...
  const lt = {
      encode: function (t, e, r = !1) {
        ...
        for (o = 0; o < t.length; o++)
          for (
            h = 0, a = t[o], u += a > 0 || (u.length ^ o) > 0 ? "" : "1";
            h in i || a > 0;
      ...
      decode: function (t, e) {
        ...
        let o,
          ...
          u = 0;
        for (o = 0; o < t.length; o++) {
          if (((u = 0), (a = r.indexOf(t[o])), a < 0))
            throw new Error(`Character range out of bounds: ${a}`);
          for (a > 0 || (i.length ^ o) > 0 || i.push(0); u in s || a > 0; )
            (c = s[u]),
              (c = c > 0 ? c * n + a : a),
              (a = c >> 8),
              (s[u] = c % 256),
    ...
    gt = (t) =>
      (function (t) {
        const e = t.slice(0, -4),
          r = t.slice(-4);
        if (ct(e).slice(0, 4).toString() !== r.toString())
  ...
  function xt(t, e, r, n = !0) {
    ...
    for (const n of t) {
      ...
      for (i = ((i << e) | n) & c, o += e; o >= r; )
        (o -= r), s.push((i >> o) & a);
    }
    if (n) o > 0 && s.push((i << (r - o)) & a);
    else if (o >= e || ((i << (r - o)) & a) > 0)
  ...
  function Et(t) {
    ...
    for (let n = r + 1; n < t.length; ++n) {
      ...
      if (-1 === r)
        throw new Error("Character idx out of bounds: " + String(n));
      e.push(r);
    }
    const s = bt.find((t) => t.version === e[0]) ?? bt[0];
    if (
      !(function (t, e, r) {
  ...
  function It(t, e = !1) {
    ...
    for (let e = 0; e < t.length; e++)
      for (i = (i << 8) | t[e], s += 8; s >= 6; )
        (s -= 6), (n += r[(i >> s) & 63]);
    if (s > 0)
      for (i <<= 6 - s, n += r[63 & i]; s < 6; ) (n += e ? "" : "="), (s += 2);
    return n;
  }
  function Pt(t, e = !1) {
    const r =
        e || t.includes("-") || t.includes("_") ? Ot.split("") : kt.split(""),
      n = (t = t.replace(/=+$/, "")).split("");
    let s = 0,
      i = 0;
    const o = [];
    for (let t = 0; t < n.length; t++) {
      ...
      (s += 6),
        (i <<= 6),
        (i |= a),
        s >= 8 && ((s -= 8), o.push((i >>> s) & 255));
    }
    return new Uint8Array(o);
  }
  const Tt = { encode: It, decode: Pt },
    Ut = (t) => It(t, !0),
    Ct = (t) => Pt(t, !0);
  let Lt = class t extends Uint8Array {
      static {
        this.num = (e, r, n = "le") => {
          const s = new t(tt(e), r);
          return "le" === n ? s.reverse() : s;
        };
      }
      static {
        this.big = (e, r, n = "le") => {
          const s = new t(rt(e), r);
          return "le" === n ? s.reverse() : s;
        };
      }
      static {
        this.bin = (e, r) =>
          new t(
            (function (t) {
              if ("string" == typeof t) t = t.split("").map(Number);
              else if (!Array.isArray(t))
                throw new Error(
                  "Invalid input type: expected a string or an array of numbers."
                );
              if (t.length % 8 != 0)
                throw new Error(`Binary array is invalid length: ${t.length}`);
      ...
      static {
        this.any = (e, r) => new t(at(e, !1), r);
      }
      static {
        this.raw = (e, r) => new t(e, r);
      }
      static {
        this.str = (e, r) => new t(Q(e), r);
      }
      static {
        this.hex = (e, r) => new t(X(e), r);
      }
      static {
        this.json = (e) => new t(Q(JSON.stringify(e)));
      }
      static {
        this.bytes = (e, r) => new t(at(e, !0), r);
      }
      static {
        this.base64 = (e) => new t(Tt.decode(e));
      }
      static {
        this.b64url = (e) => new t(Ct(e));
      }
      static {
        this.bech32 = (e) => new t(At.decode(e));
      }
      static {
        this.b58chk = (e) => new t(gt(e));
      }
      constructor(t, e) {
      ...
      static revive(t) {
        return (function (t) {
          if ((t instanceof Uint8Array && (t = nt(t)), "string" == typeof t))
            try {
              return JSON.parse(t);
            } catch {
              return t;
    ...
    Nt = class {
      ...
      read(t) {
        ...
        const e = this.peek(t);
        return (
          (this.data = this.data.slice(t)), (this.size = this.data.length), e
        );
      }
      readSize(t) {
  ...
  function Ht(t, e) {
    const r = Lt.bytes(t);
    if (r.length !== e)
      throw new Error(`Invalid input size: ${r.hex} !== ${e}`);
  }
  function Zt(t, e) {
  ...
  const zt = {
      ...
      scriptPubKey: function (t) {
        ...
        return (
          Ht(e, 20),
          ["OP_DUP", "OP_HASH160", e.hex, "OP_EQUALVERIFY", "OP_CHECKSIG"]
        );
      },
  ...
  function Wt(t = [], e = !0) {
    let r = Lt.num(0);
    return (
      Array.isArray(t) && (r = Lt.raw(Yt(t))),
      Vt(t) && (r = Lt.hex(t)),
      t instanceof Uint8Array && (r = Lt.raw(t)),
      e && (r = r.prefixSize("be")),
      r
    );
  }
        ...
        return Lt.num(
          (function (t) {
            for (const [e, r] of Object.entries($t))
              if (e === t) return Number(r);
            throw new Error("OPCODE not found:" + t);
          })(t),
          1
        );
      e = Vt(t) ? Lt.hex(t) : Lt.str(t);
    } else if (((e = Lt.bytes(t)), 1 === e.length && e[0] <= 16))
      return 0 !== e[0] && (e[0] += 80), e;
    if (e.length > Gt) {
      const t = (function (t) {
        const e = [],
          r = new Nt(t);
  ...
  function Xt(t, e = !1) {
    ...
    if (e) {
      ...
      if (r.length !== t)
        throw new Error(
          `Varint does not match stream size: ${t} !== ${r.length}`
        );
      r = r.slice(1);
    }
    return (function (t) {
      ...
      let s,
        ...
        a = 0;
      for (; a < n; )
        switch (((s = e.read(1).num), (i = qt(s)), a++, i)) {
          case "varint":
  ...
  const te = {
      toAsm: function (t, e) {
        if (
          (Array.isArray(t) && (t = Wt(t, e)), t instanceof Uint8Array || Vt(t))
        )
          return Xt(t, e);
      ...
      toBytes: function (t, e) {
        if (
          ((t instanceof Uint8Array || Vt(t)) && (t = Xt(t, e)),
          Array.isArray(t))
        )
          return Wt(t, e);
        throw new Error("Invalid format: " + String(typeof t));
  ...
  const se = {
      ...
      decode: function (t, e = "main") {
        if (!re(t, e))
          throw new TypeError(`Invalid p2sh address for network ${e}:` + t);
        return Lt.b58chk(t).slice(1);
      },
      scriptPubKey: function (t) {
    ...
    ie = { main: "bc", testnet: "tb", signet: "tb", regtest: "bcrt" },
    oe = ["bc1q", "tb1q", "bcrt1q"];
  function ae(t) {
  ...
  const be = {
    ...
    we = { version: 2, vin: [], vout: [], locktime: 0 },
    ve = { scriptSig: [], sequence: 4294967293, witness: [] },
    xe = { value: 0n, scriptPubKey: [] };
  function _e(t) {
    const e = { ...we, ...t };
    return (
      (e.vin = e.vin.map((t) => ({ ...ve, ...t }))),
      (e.vout = e.vout.map((t) => ({ ...xe, ...t }))),
      e
    );
  }
  function Ee(t, e) {
    const { version: r, vin: n, vout: s, locktime: i } = _e(t),
      o =
        !0 !== e &&
        (function (t) {
          for (const e of t) {
      ...
      a = [Se(r)];
    o && a.push(Lt.hex("0001")),
      a.push(
        (function (t) {
          const e = [Lt.varInt(t.length)];
          for (const r of t) {
            const { txid: t, vout: n, scriptSig: s, sequence: i } = r;
  ...
  function Ie(t) {
    const { value: e, scriptPubKey: r } = t,
      n = [];
  ...
  function Ce(t) {
    ...
    return { version: r, vin: s, vout: i, locktime: o };
  }
  function Le(t) {
    return {
  ...
  function Ne(t) {
    return { value: t.read(8).reverse().big, scriptPubKey: Re(t, !0) };
  }
  function He(t) {
    const e = [],
      r = t.readSize();
  ...
  const je = {
      ...
      toJson: function (t) {
        if (Mt(t)) return Ce(t);
        if ("object" == typeof t && !(t instanceof Uint8Array))
          return Ee(t), _e(t);
        throw new Error("Invalid format: " + String(typeof t));
      },
    },
    ...
    ze = [
      ...
      252, 254, 102, 126, 128, 132, 150, 152, 186, 188, 190,
    ];
  function $e(t = []) {
    const e = [...t],
      r = (function (t) {
        ...
        return (
          Vt(e) && (e = Lt.hex(e)),
          t.length > 1 && e instanceof Uint8Array && 80 === e[0]
            ? (t.pop(), Lt.raw(e))
            : null
        );
      })(e),
    ...
    return { annex: r, cblock: n, script: s, params: i };
  }
  function Fe(t) {
    ...
    for (const [t, r] of De) {
      const n = t,
        { groups: s } = r.exec(e) ?? {},
        { hash: i } = s ?? {};
      if (Vt(i)) return { type: n, data: Lt.hex(i) };
    }
    return { type: "raw", data: Lt.hex(e) };
  }
  const qe = {
      create: _e,
      encode: Ee,
  ...
  const We = {
      ...
      fromScriptPubKey: function (t, e) {
        const { type: r, data: n } = qe.util.readScriptPubKey(t);
  ...
  function Je(t, e, r = {}) {
    ...
    const o = qe.fmt.toJson(t),
      { version: a, vin: c, vout: u, locktime: h } = o,
      { txid: d, vout: f, prevout: l, sequence: p } = c[e],
      { value: g } = l ?? {};
    ...
    if (ee.fmt.toAsm(m).includes("OP_CODESEPARATOR"))
      throw new Error(
  ...
  function Qe(t, e) {
    ...
    const r = [];
    for (const { txid: e, vout: n } of t) r.push(Ae(e)), r.push(ke(n));
    return Lt.join(r).toHash("hash256");
  }
  function Xe(t, e, r) {
    if (r || 1 !== e) return Lt.num(0, 32);
    const n = [];
    for (const { sequence: e } of t) n.push(Oe(e));
    return Lt.join(n).toHash("hash256");
  }
  function tr(t, e, r) {
    const n = [];
    if (1 === r) {
      for (const { value: e, scriptPubKey: r } of t)
        n.push(Be(e)), n.push(ee.encode(r, !0));
      return Lt.join(n).toHash("hash256");
    }
    if (3 === r && e < t.length) {
      const { value: r, scriptPubKey: s } = t[e];
      return (
        n.push(Be(r)), n.push(ee.encode(s, !0)), Lt.join(n).toHash("hash256")
      );
    }
    return Lt.num(0, 32);
  }
  ...
  function dr(t = 32) {
    if (ir && "function" == typeof ir.getRandomValues)
  ...
  const vr = BigInt(0),
    ...
    Sr = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
  function Ar(t) {
  ...
  /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const Fr =
      BigInt(0),
    qr = BigInt(1),
    Kr = BigInt(2),
    Vr = BigInt(3),
  ...
  /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const {
    ...
    hn = {
      ...
      _parseInt(t) {
        ...
        return { d: cn(n), l: t.subarray(r + 2) };
      },
      toSig(t) {
        const { Err: e } = hn,
        ...
        const { d: s, l: i } = hn._parseInt(r.subarray(2)),
          { d: o, l: a } = hn._parseInt(i);
        if (a.length)
  ...
  function mn(t) {
    ...
    function c(t) {
      ...
      if (r && "bigint" != typeof t) {
        if (
          (t instanceof Uint8Array && (t = Ar(t)),
    ...
    class d {
      ...
      multiplyUnsafe(t) {
        ...
        let { k1neg: i, k1: o, k2neg: c, k2: u } = s.splitScalar(t),
          h = n,
          f = n,
          p = this;
        for (; o > dn || u > dn; )
      ...
      multiply(t) {
        ...
        const { endo: o } = e;
        if (o) {
          const { k1neg: t, k1: e, k2neg: a, k2: c } = o.splitScalar(i);
          let { p: u, f: h } = this.wNAF(e),
            { p: f, f: p } = this.wNAF(c);
          (u = l.constTimeNegate(t, u)),
            (f = l.constTimeNegate(a, f)),
        ...
        return {
          ...
          unsafeLadder(e, r) {
            let n = t.ZERO,
              s = e;
            for (; r > sn; )
              r & on && (n = n.add(s)), (s = s.double()), (r >>= on);
            return n;
          },
          precomputeWindow(t, e) {
            const { windows: r, windowSize: s } = n(e),
              i = [];
            let o = t,
              a = o;
            for (let t = 0; t < r; t++) {
          ...
          wNAFCached(t, e, r, n) {
            ...
            return (
              i ||
                ((i = this.precomputeWindow(t, s)), 1 !== s && e.set(t, n(i))),
              this.wNAF(s, i, r)
            );
          },
        };
  ...
  function yn(t) {
    ...
    const {
        ...
        toBytes(t, e, n) {
          const s = e.toAffine(),
            ...
            o = Lr;
          return n
            ? o(Uint8Array.from([e.hasEvenY() ? 2 : 3]), i)
            : o(Uint8Array.from([4]), i, r.toBytes(s.y));
        },
        fromBytes(t) {
          const e = t.length,
            n = t[0],
          ...
          if (e !== s || (2 !== n && 3 !== n)) {
            ...
            throw new Error(
              `Point of length ${e} was invalid. Expected ${s} compressed bytes or ${i} uncompressed bytes`
            );
          }
          {
            const t = Ir(o);
    ...
    class g {
      ...
      static fromCompact(t) {
        ...
        return (
          (t = Cr("compactSignature", t, 2 * r)),
          new g(p(t, 0, r), p(t, r, 2 * r))
        );
      }
      static fromDER(t) {
        const { r: e, s: r } = hn.toSig(Cr("DER", t));
        return new g(e, r);
      }
      assertValidity() {
      ...
      normalizeS() {
        return this.hasHighS()
          ? new g(this.r, o(-this.s), this.recovery)
          : this;
      }
      toDERRawBytes() {
    ...
    function _(t, n, s = E) {
      ...
      const { hash: i, randomBytes: h } = e;
      let { lowS: f, prehash: p, extraEntropy: m } = s;
      null == f && (f = !0),
        (t = Cr("msgHash", t)),
        p && (t = Cr("prehashed msgHash", i(t)));
      const y = w(t),
        v = u(n),
        _ = [x(v), x(y)];
      if (null != m) {
    ...
    return (
      c.BASE._setWindowSize(8),
      {
        ...
        sign: function (t, r, n = E) {
          const { seed: s, k2sig: i } = _(t, r, n);
          return jr(e.hash.outputLen, e.nByteLength, e.hmac)(s, i);
        },
        verify: function (t, r, n, s = S) {
          const i = t;
          if (((r = Cr("msgHash", r)), (n = Cr("publicKey", n)), "strict" in s))
            throw new Error("options.strict was renamed to lowS");
          const { lowS: u, prehash: h } = s;
          let d, f;
          try {
          ...
          const { r: l, s: p } = d,
            ...
            b = o(m * y),
            v = o(l * y),
            x = c.BASE.multiplyAndAddUnsafe(f, b, v)?.toAffine();
          return !!x && o(x.x) === l;
        },
        ProjectivePoint: c,
        Signature: g,
  ...
  const On = (function (t, e, r = !1, n = {}) {
      ...
      const { nBitLength: s, nByteLength: i } = nn(t, e);
      if (i > 2048)
          ...
          pow: (t, e) =>
            (function (t, e, r) {
              ...
              let n = t.ONE,
                s = e;
              for (; r > Fr; )
                r & qr && (n = t.mul(n, s)), (s = t.sqr(s)), (r >>= qr);
              return n;
            })(a, t, e),
          ...
          invertBatch: (t) =>
            (function (t, e) {
              const r = new Array(e.length),
                n = e.reduce(
                  (e, n, s) => (t.is0(n) ? e : ((r[s] = e), t.mul(e, n))),
                  t.ONE
                ),
                s = t.inv(n);
              return (
                e.reduceRight(
                  (e, n, s) =>
                    t.is0(n) ? e : ((r[s] = t.mul(e, r[s])), t.mul(e, n)),
                  s
                ),
                r
              );
    ...
    })(
      {
        ...
        endo: {
          ...
          splitScalar: (t) => {
            ...
            const d = u > o,
              f = h > o;
            if ((d && (u = e - u), f && (h = e - h), u > o || h > o))
              throw new Error("splitScalar: Endomorphism failed, k=" + t);
            return { k1neg: d, k1: u, k2neg: f, k2: h };
          },
        },
      },
      wr
  ...
  function Dn(t) {
    ...
    return { scalar: r.hasEvenY() ? e : Zn(-e), bytes: Ln(r) };
  }
  function zn(t) {
  ...
  const qn = {
    ...
    Kn = (function (t, e) {
      ...
      return (e, n) => {
        const [s, i, o, a] = r.map((r) =>
          r.reduce((r, n) => t.add(t.mul(r, e), n))
        );
        return (e = t.div(s, i)), (n = t.mul(n, t.div(o, a))), { x: e, y: n };
      };
    })(
      On,
      [
    ...
    Vn = (function (t, e) {
      if ((rn(t), !t.isValid(e.A) || !t.isValid(e.B) || !t.isValid(e.Z)))
        ...
        if (t.ORDER % gn === pn) {
          ...
          d = (e, s) => {
            ...
            const c = t.mul(a, n),
              u = t.mul(t.sqr(a), s),
              h = t.eql(u, e);
            return { isValid: h, value: t.cmov(c, a, h) };
          };
        }
        return d;
      })(t, e.Z);
      ...
      return (n) => {
        ...
        return (d = t.cmov(t.neg(d), d, p)), (h = t.div(h, a)), { x: h, y: d };
      };
    })(On, {
      A: BigInt(
  ...
  !(function (t, e, r) {
    ...
    Bn.ProjectivePoint,
    (t) => {
      const { x: e, y: r } = Vn(On.create(t[0]));
      return Kn(e, r);
    },
    {
  ...
  function ps(t, e = !1) {
    return e
      ? { h: Number(t & fs), l: Number((t >> ls) & fs) }
      : { h: 0 | Number((t >> ls) & fs), l: 0 | Number(t & fs) };
  }
  var gs = {
    fromBig: ps,
    split: function (t, e = !1) {
  ...
  class vs extends ss {
    ...
    process(t, e) {
      for (let r = 0; r < 16; r++, e += 4)
        (bs[r] = t.getUint32(e)), (ws[r] = t.getUint32((e += 4)));
      for (let t = 16; t < 80; t++) {
        const e = 0 | bs[t - 15],
          r = 0 | ws[t - 15],
      ...
      for (let t = 0; t < 80; t++) {
        const e =
            gs.rotrSH(h, d, 14) ^ gs.rotrSH(h, d, 18) ^ gs.rotrBH(h, d, 41),
        ...
        (m = 0 | p),
          ...
          (f = 0 | h),
          (l = 0 | d),
          ({ h: h, l: d } = gs.add(0 | c, 0 | u, 0 | _, 0 | E)),
          (c = 0 | o),
          (u = 0 | a),
          (o = 0 | s),
          (a = 0 | i),
      ...
      ({ h: r, l: n } = gs.add(0 | this.Ah, 0 | this.Al, 0 | r, 0 | n)),
        ({ h: s, l: i } = gs.add(0 | this.Bh, 0 | this.Bl, 0 | s, 0 | i)),
        ({ h: o, l: a } = gs.add(0 | this.Ch, 0 | this.Cl, 0 | o, 0 | a)),
        ({ h: c, l: u } = gs.add(0 | this.Dh, 0 | this.Dl, 0 | c, 0 | u)),
        ({ h: h, l: d } = gs.add(0 | this.Eh, 0 | this.El, 0 | h, 0 | d)),
        ({ h: f, l: l } = gs.add(0 | this.Fh, 0 | this.Fl, 0 | f, 0 | l)),
        ({ h: p, l: g } = gs.add(0 | this.Gh, 0 | this.Gl, 0 | p, 0 | g)),
        ({ h: m, l: y } = gs.add(0 | this.Hh, 0 | this.Hl, 0 | m, 0 | y)),
        this.set(r, n, s, i, o, a, c, u, h, d, f, l, p, g, m, y);
    }
    roundClean() {
      bs.fill(0), ws.fill(0);
  ...
  const As = new Uint8Array([
    ...
    ks = Uint8Array.from({ length: 16 }, (t, e) => e),
    Os = ks.map((t) => (9 * t + 5) % 16);
  let Bs = [ks],
    Is = [Os];
  for (let t = 0; t < 4; t++)
    for (let e of [Bs, Is]) e.push(e[t].map((t) => As[t]));
  const Ps = [
      [11, 14, 15, 12, 5, 8, 7, 9, 11, 13, 14, 15, 6, 7, 9, 8],
      [12, 13, 11, 15, 6, 9, 9, 7, 12, 15, 11, 13, 7, 8, 7, 7],
      [13, 15, 14, 11, 7, 7, 6, 8, 13, 14, 13, 12, 5, 5, 6, 9],
  ...
  const ii = {
    ...
    ai = (t) =>
      (function (t) {
        const e = t.slice(0, -4),
          r = t.slice(-4);
        if (ti(e).slice(0, 4).toString() !== r.toString())
          throw new Error("Invalid checksum!");
        return e;
      })(ii.decode(t, "base58")),
  ...
  function gi(t) {
    ...
    const s = hi.find((t) => t.version === e[0]) ?? hi[0];
    if (
      !(function (t, e, r) {
  ...
  function _i(t, e = !1) {
    const r =
        e || t.includes("-") || t.includes("_") ? wi.split("") : bi.split(""),
      n = (t = t.replace(/=+$/, "")).split("");
    let s = 0,
      i = 0;
    const o = [];
  ...
  const Ei = { encode: xi, decode: _i },
    Si = (t) => xi(t, !0),
    Ai = (t) => _i(t, !0);
  class ki extends Uint8Array {
    static {
      this.num = (t, e, r = "le") => {
        const n = new ki(Vs(t), e);
        return "le" === r ? n.reverse() : n;
      };
    }
    static {
      this.big = (t, e, r = "le") => {
        const n = new ki(Gs(t), e);
        return "le" === r ? n.reverse() : n;
      };
    }
    static {
    ...
    static {
      this.any = (t, e) => new ki(Xs(t, !1), e);
    }
    static {
      this.raw = (t, e) => new ki(t, e);
    }
    static {
      this.str = (t, e) => new ki(qs(t), e);
    }
    static {
      this.hex = (t, e) => new ki(Ks(t), e);
    }
    static {
      this.json = (t) => new ki(qs(JSON.stringify(t)));
    }
    static {
      this.bytes = (t, e) => new ki(Xs(t, !0), e);
    }
    static {
      this.base64 = (t) => new ki(Ei.decode(t));
    }
    static {
      this.b64url = (t) => new ki(Ai(t));
    }
    static {
      this.bech32 = (t) => new ki(yi.decode(t));
    }
    static {
      this.b58chk = (t) => new ki(ai(t));
    }
    constructor(t, e) {
    ...
    static random(t = 32) {
      return new ki(
        (function (t = 32) {
          if (Qn && "function" == typeof Qn.getRandomValues)
    ...
    static revive(t) {
      return (function (t) {
        if ((t instanceof Uint8Array && (t = Ws(t)), "string" == typeof t))
          try {
            return JSON.parse(t);
          } catch {
            return t;
  ...
  class Pi {
    ...
    static import(t) {
      const e =
        t instanceof Pi ? { x: t.x.big, y: t.y.big } : { x: t.x, y: t.y };
    ...
    eq(t) {
      return t instanceof Pi
        ? this.p.equals(new Bi(t.x.big, t.y.big, 1n))
        : t instanceof Uint8Array
        ? this.x.big === ki.raw(t).big
        : "number" == typeof t
        ? BigInt(t) === this.x.big
        : t === this.x.big;
    }
    add(t) {
      return t instanceof Pi
        ? Pi.import(this.p.add(t.p))
        : Pi.import(this.p.add(Pi.generate(t).p));
    }
    sub(t) {
      return t instanceof Pi
        ? Pi.import(this.p.subtract(t.p))
        : Pi.import(this.p.subtract(Pi.generate(t).p));
    }
    mul(t) {
      return t instanceof Pi
        ? Pi.import(this.p.multiply(t.x.big))
        : Pi.import(this.p.multiply(Ti(t)));
    }
    negate() {
  ...
  class Zi extends Uint8Array {
    ...
    constructor(t, e = {}) {
      const r = { ...Ni, ...e };
      "taproot" === r.type ? super(Zi.xfilter(t), 32) : super(ki.bytes(t), 33),
        (this.config = { ...Ni, ...e }),
  ...
  const Ri = {
      ...
      verify: function (t, e, r = {}) {
        ...
        if (
          ...
          if (!(c.length > 1 && 33 === c[1].length))
            return Zt("No pubkey provided!", s);
          u = Lt.bytes(c[1]);
        }
        const h = ee.fmt.toParam(c[0]),
          d = h.slice(0, -1),
          f = h.slice(-1)[0],
          l = Je(n, e, { ...r, sigflag: f });
        return (
          !!Li(d.hex, l.hex, u.hex, "ecdsa") || Zt("Invalid signature!", s)
        );
      },
    },
  ...
  function Di(t, e, r = {}) {
    const {
      ...
      c = qe.fmt.toJson(t),
      { version: u, vin: h, vout: d, locktime: f } = c;
    ...
    const { txid: l, vout: p, sequence: g, witness: m = [] } = h[e],
      y = 128 == (128 & s),
      b = (function (t) {
        if (void 0 === t) return;
        ...
        if (e instanceof Uint8Array && 80 === e[0])
          return Lt.raw(e).prefixSize("be").digest;
        return;
      })(m),
    ...
    if (!y) {
      ...
      x.push(
        (function (t) {
          const e = [];
          for (const { txid: r, vout: n } of t) e.push(Ae(r)), e.push(ke(n));
          return Lt.join(e).digest;
        })(h),
        (function (t) {
          const e = [];
          for (const { value: r } of t) e.push(Be(r));
          return Lt.join(e).digest;
        })(t),
        (function (t) {
          const e = [];
          for (const { scriptPubKey: r } of t) e.push(Wt(r, !0));
          return Lt.join(e).digest;
        })(t),
        (function (t) {
          const e = [];
          for (const { sequence: r } of t) e.push(Oe(r));
          return Lt.join(e).digest;
        })(h)
      );
    }
    if (
      (((3 & s) < 2 || (3 & s) > 3) &&
        x.push(
          (function (t) {
            const e = [];
            for (const { value: r, scriptPubKey: n } of t)
              e.push(Be(r)), e.push(ee.encode(n, !0));
            return Lt.join(e).digest;
          })(d)
        ),
      x.push(Lt.num(w, 1)),
      ...
      const { value: t, scriptPubKey: r } = zi(h[e]);
    ...
    return (
      ...
      void 0 !== n && x.push(Lt.bytes(n), Lt.num(o), Lt.num(a, 4)),
      Lt.join(x).digest
    );
  }
  function zi(t) {
    if (void 0 === t.prevout)
      throw new Error("Prevout data missing for input: " + String(t.txid));
    return t.prevout;
  }
  const $i =
  ...
  function Mi(t, e) {
    return (
      e < t && ([t, e] = [e, t]),
      Lt.join([Ki("TapBranch"), Lt.hex(t).raw, Lt.hex(e).raw]).digest.hex
    );
  }
  function Gi(t, e, r = []) {
    const n = [],
  ...
  const to = 192;
  function eo(t, e = {}) {
    const { isPrivate: r = !1, tree: n = [], version: s = to } = e,
    ...
    const d = Lt.join(h);
    if (void 0 !== o && !ro(a, o, d, e))
      throw new Error("Path checking failed! Unable to generate path.");
    return [pe(a).hex, d.hex];
  }
  function ro(t, e, r, n = {}) {
    const { isPrivate: s = !1, throws: i = !1 } = n,
      { parity: o, paths: a, intkey: c } = no(r),
  ...
  function no(t) {
    ...
    if (0 !== e.size)
      throw new Error("Non-empty buffer on control block: " + String(e));
    return { intkey: n, paths: o, parity: i, version: s };
  }
  function so(t = 2) {
    if (0 === t || 1 === t) return t;
  ...
  const io = {
      ...
      verify: function (t, e, r = {}) {
        const n = qe.fmt.toJson(t),
          { throws: s = !1 } = r,
          { prevout: i, witness: o = [] } = n.vin[e],
          a = qe.util.readWitness(o),
          { cblock: c, script: u, params: h } = a;
        let d;
        if (h.length < 1) return Zt("Invalid witness data: " + String(o), s);
        const { scriptPubKey: f } = i ?? {};
        if (void 0 === f) return Zt("Prevout scriptPubKey is empty!", s);
        const { type: l, data: p } = qe.util.readScriptPubKey(f);
        if ("p2tr" !== l)
          return Zt("Prevout script is not a valid taproot output:" + p.hex, s);
        if (32 !== p.length)
          return Zt("Invalid tapkey length: " + String(p.length), s);
        if (null !== c && null !== u) {
          const t = Vi(u, 254 & c[0]);
          if (((r.extension = t), !ro(p, t, c, { throws: s })))
            return Zt("cblock verification failed!", s);
        }
        d =
          void 0 !== r.pubkey
            ? Lt.bytes(r.pubkey)
            : h.length > 1 && 32 === h[1].length
            ? Lt.bytes(h[1])
            : Lt.bytes(p);
        const g = ee.fmt.toParam(h[0]),
          m = new Nt(g),
          y = m.read(64).raw;
        return 1 === m.size && ((r.sigflag = m.read(1).num), 0 === r.sigflag)
          ? Zt("0x00 is not a valid appended sigflag!", s)
          : !!(function (t, e, r, n = !1) {
              const s = new Pi(pe(r)),
                i = Lt.bytes(e),
                o = Lt.bytes(t).stream;
              o.size < 64 &&
                Zt("Signature length is too small: " + String(o.size), n);
              const a = o.read(32);
              a.big > $i && Zt("Signature r value greater than field size!", n);
              const c = o.read(32);
              c.big > Fi &&
                Zt("Signature s value greater than curve order!", n);
              const u = new Ii(Rt("BIP0340/challenge", a.raw, s.x.raw, i)),
                h = new Ii(c).point,
                d = s.mul(u.big),
                f = h.sub(d);
              return (
                f.hasOddY && Zt("Signature R value has odd Y coordinate!", n),
                0n === f.x.big && Zt("Signature R value is infinite!", n),
                f.x.big === a.big
              );
            })(y, Di(n, e, r), d, s) || Zt("Invalid signature!", s);
      },
    },
    oo = { segwit: Ri, taproot: io },
    ao = {
      getTag: Ki,
      getLeaf: Vi,
      getBranch: Mi,
    ...
    co = {
      getPubKey: function (t, e = {}) {
        return eo(t, { ...e, isPrivate: !1 });
      },
      getSecKey: function (t, e = {}) {
        return eo(t, { ...e, isPrivate: !0 });
      },
      ...
      util: { readCtrlBlock: no, readParityBit: so },
    };
  class uo {
    constructor(t) {
  ...
  class lo {
    ...
    get estDate() {
      return this.isTimelock
        ? new Date(Date.now() + this.value * fo * 1e3)
        : new Date(Date.now() + 600 * this.value * 1e3);
    }
    set estDate(t) {
  ...
  let po = class {
    constructor(t) {
      (this.value = BigInt(t.value)),
        (this.scriptPubKey = new uo(t.scriptPubKey));
    }
    get type() {
      const { type: t } = Fe(this.scriptPubKey.raw);
      return t;
    }
  };
  class go {
  ...
  let mo = class {
    ...
    sign(t, e) {
      if (this.type.startsWith("p2w"))
        return oo.segwit.sign(t, this._tx, this.idx, e);
      if (this.type.startsWith("p2tr"))
        return oo.taproot.sign(t, this._tx, this.idx, e);
      if (this.type.startsWith("p2pkh") || this.type.startsWith("p2sh"))
        throw new Error(
          "This library does not support signing legacy transactions."
        );
  ...
  class yo {
    ...
    get estDate() {
      return this.isTimelock
        ? new Date(Date.now() + 1e3 * this.value)
        : new Date(Date.now() + 600 * this.value * 1e3);
    }
    set estDate(t) {
      ...
      const e =
        ...
        n = (t) => {
          for (const s of t.issues)
            ...
            else if (0 === s.path.length) r._errors.push(e(s));
            else {
              let t = r,
                n = 0;
              for (; n < s.path.length; ) {
                const r = s.path[n];
                n === s.path.length - 1
                  ? ((t[r] = t[r] || { _errors: [] }), t[r]._errors.push(e(s)))
                  : (t[r] = t[r] || { _errors: [] }),
                  (t = t[r]),
                  n++;
              }
  ...
  const So = (t, e) => {
    ...
    switch (t.code) {
      ...
      case _o.invalid_enum_value:
        r = `Invalid enum value. Expected ${bo.joinValues(
          t.options
        )}, received '${t.received}'`;
        break;
  ...
  const Oo = (t) => {
    ...
    const c = n
      ...
      .slice()
      .reverse();
    for (const t of c) a = t(o, { data: e, defaultError: a }).message;
  ...
  class Io {
    ...
    static async mergeObjectAsync(t, e) {
      const r = [];
      for (const t of e) r.push({ key: await t.key, value: await t.value });
      return Io.mergeObjectSync(t, r);
    }
    static mergeObjectSync(t, e) {
      const r = {};
      for (const n of e) {
        const { key: e, value: s } = n;
        if ("aborted" === e.status) return Po;
        if ("aborted" === s.status) return Po;
        "dirty" === e.status && t.dirty(),
          "dirty" === s.status && t.dirty(),
          (void 0 !== s.value || n.alwaysSet) && (r[e.value] = s.value);
      }
      return { status: t.value, value: r };
    }
  }
  const Po = Object.freeze({ status: "aborted" }),
    To = (t) => ({ status: "dirty", value: t }),
    Uo = (t) => ({ status: "valid", value: t }),
  ...
  var Zo;
  !(function (t) {
    (t.errToObj = (t) => ("string" == typeof t ? { message: t } : t || {})),
      (t.toString = (t) =>
  ...
  const jo = (t, e) => {
    if (No(e)) return { success: !0, data: e.value };
  ...
  function Do(t) {
    ...
    if (e) return { errorMap: e, description: s };
    return {
      errorMap: (t, e) =>
        "invalid_type" !== t.code
  ...
  class zo {
    ...
    safeParse(t, e) {
      ...
      const n = {
          common: {
            issues: [],
            async:
              null !== (r = null == e ? void 0 : e.async) && void 0 !== r && r,
    ...
    refine(t, e) {
      ...
      return this._refinement((e, n) => {
        const s = t(e),
          i = () => n.addIssue({ code: _o.custom, ...r(e) });
    ...
    refinement(t, e) {
      return this._refinement(
        (r, n) =>
          !!t(r) || (n.addIssue("function" == typeof e ? e(r, n) : e), !1)
      );
    }
    _refinement(t) {
      return new Ba({
    ...
    brand() {
      return new Na({ typeName: ja.ZodBranded, type: this, ...Do(this._def) });
    }
    catch(t) {
      const e = "function" == typeof t ? t : () => t;
      return new Ua({
    ...
    describe(t) {
      return new (0, this.constructor)({ ...this._def, description: t });
    }
    pipe(t) {
  ...
  class Yo extends zo {
    constructor() {
      super(...arguments),
        (this._regex = (t, e, r) =>
          this.refinement((e) => t.test(e), {
            validation: e,
            code: _o.invalid_string,
            ...Zo.errToObj(r),
          })),
        (this.nonempty = (t) => this.min(1, Zo.errToObj(t))),
        (this.trim = () =>
          new Yo({
            ...this._def,
      ...
      for (const o of this._def.checks)
        if ("min" === o.kind)
          ...
          o.regex.test(t.data) ||
            ...
            e.dirty());
        } else if ("trim" === o.kind) t.data = t.data.trim();
          ...
          t.data.includes(o.value, o.position) ||
            ...
            e.dirty());
        else if ("toLowerCase" === o.kind) t.data = t.data.toLowerCase();
        else if ("toUpperCase" === o.kind) t.data = t.data.toUpperCase();
          ...
          "ip" === o.kind
            ...
            : bo.assertNever(o);
      var n, s, i;
      return { status: e.value, value: t.data };
    }
    _addCheck(t) {
      return new Yo({ ...this._def, checks: [...this._def.checks, t] });
    }
    email(t) {
      return this._addCheck({ kind: "email", ...Zo.errToObj(t) });
    }
    url(t) {
      return this._addCheck({ kind: "url", ...Zo.errToObj(t) });
    }
    emoji(t) {
      return this._addCheck({ kind: "emoji", ...Zo.errToObj(t) });
    }
    uuid(t) {
      return this._addCheck({ kind: "uuid", ...Zo.errToObj(t) });
    }
    cuid(t) {
      return this._addCheck({ kind: "cuid", ...Zo.errToObj(t) });
    }
    cuid2(t) {
      return this._addCheck({ kind: "cuid2", ...Zo.errToObj(t) });
    }
    ulid(t) {
      return this._addCheck({ kind: "ulid", ...Zo.errToObj(t) });
    }
    ip(t) {
      return this._addCheck({ kind: "ip", ...Zo.errToObj(t) });
    }
    datetime(t) {
      var e;
        ...
        : this._addCheck({
            ...
            precision:
              void 0 === (null == t ? void 0 : t.precision)
                ...
                : t.precision,
            offset:
              null !== (e = null == t ? void 0 : t.offset) && void 0 !== e && e,
            ...Zo.errToObj(null == t ? void 0 : t.message),
          });
    }
    regex(t, e) {
      return this._addCheck({ kind: "regex", regex: t, ...Zo.errToObj(e) });
    }
    includes(t, e) {
    ...
    endsWith(t, e) {
      return this._addCheck({ kind: "endsWith", value: t, ...Zo.errToObj(e) });
    }
    min(t, e) {
      return this._addCheck({ kind: "min", value: t, ...Zo.errToObj(e) });
    }
    max(t, e) {
      return this._addCheck({ kind: "max", value: t, ...Zo.errToObj(e) });
    }
    length(t, e) {
      return this._addCheck({ kind: "length", value: t, ...Zo.errToObj(e) });
    }
    get isDatetime() {
  ...
  class Qo extends zo {
        ...
        if ("int" === n.kind)
          ...
          "multipleOf" === n.kind
            ...
            ? Number.isFinite(t.data) ||
              ((e = this._getOrReturnCtx(t, e)),
              Bo(e, { code: _o.not_finite, message: n.message }),
              r.dirty())
            : bo.assertNever(n);
    ...
    setLimit(t, e, r, n) {
      return new Qo({
        ...
        checks: [
          ...this._def.checks,
          { kind: t, value: e, inclusive: r, message: Zo.toString(n) },
        ],
      });
    }
    _addCheck(t) {
      return new Qo({ ...this._def, checks: [...this._def.checks, t] });
    }
    int(t) {
      return this._addCheck({ kind: "int", message: Zo.toString(t) });
    }
    positive(t) {
      return this._addCheck({
        kind: "min",
    ...
    finite(t) {
      return this._addCheck({ kind: "finite", message: Zo.toString(t) });
    }
    safe(t) {
      return this._addCheck({
        kind: "min",
    ...
    get isInt() {
      return !!this._def.checks.find(
        (t) =>
          "int" === t.kind || ("multipleOf" === t.kind && bo.isInteger(t.value))
      );
    }
    get isFinite() {
      let t = null,
  ...
  class Xo extends zo {
    ...
    _addCheck(t) {
      return new Xo({ ...this._def, checks: [...this._def.checks, t] });
    }
    positive(t) {
      return this._addCheck({
        kind: "min",
  ...
  class ea extends zo {
    _parse(t) {
      ...
      if (isNaN(t.data.getTime())) {
        return Bo(this._getOrReturnCtx(t), { code: _o.invalid_date }), Po;
      }
      const e = new Io();
      let r;
      for (const n of this._def.checks)
        "min" === n.kind
          ...
          ? t.data.getTime() > n.value &&
            ...
            e.dirty())
          : bo.assertNever(n);
      return { status: e.value, value: new Date(t.data.getTime()) };
    }
    _addCheck(t) {
  ...
  ra.create = (t) => new ra({ typeName: ja.ZodSymbol, ...Do(t) });
  class na extends zo {
    _parse(t) {
  ...
  na.create = (t) => new na({ typeName: ja.ZodUndefined, ...Do(t) });
  class sa extends zo {
    _parse(t) {
  ...
  sa.create = (t) => new sa({ typeName: ja.ZodNull, ...Do(t) });
  class ia extends zo {
    constructor() {
  ...
  ia.create = (t) => new ia({ typeName: ja.ZodAny, ...Do(t) });
  class oa extends zo {
    constructor() {
  ...
  oa.create = (t) => new oa({ typeName: ja.ZodUnknown, ...Do(t) });
  class aa extends zo {
    _parse(t) {
      const e = this._getOrReturnCtx(t);
      return (
  ...
  aa.create = (t) => new aa({ typeName: ja.ZodNever, ...Do(t) });
  class ca extends zo {
    _parse(t) {
      if (this._getType(t) !== vo.undefined) {
        const e = this._getOrReturnCtx(t);
  ...
  ca.create = (t) => new ca({ typeName: ja.ZodVoid, ...Do(t) });
  class ua extends zo {
    _parse(t) {
      const { ctx: e, status: r } = this._processInputParams(t),
        n = this._def;
      if (e.parsedType !== vo.array)
        return (
          Bo(e, {
            code: _o.invalid_type,
            expected: vo.array,
      ...
      if (
        ...
        return Promise.all(
          [...e.data].map((t, r) => n.type._parseAsync(new Ro(e, t, e.path, r)))
        ).then((t) => Io.mergeArray(r, t));
      const s = [...e.data].map((t, r) =>
        n.type._parseSync(new Ro(e, t, e.path, r))
      );
    ...
    min(t, e) {
      return new ua({
        ...this._def,
        minLength: { value: t, message: Zo.toString(e) },
      });
    }
    max(t, e) {
      return new ua({
        ...this._def,
        maxLength: { value: t, message: Zo.toString(e) },
      });
    }
    length(t, e) {
      return new ua({
        ...this._def,
        exactLength: { value: t, message: Zo.toString(e) },
      });
    }
    nonempty(t) {
      return this.min(1, t);
  ...
  function ha(t) {
    if (t instanceof da) {
      ...
      return new da({ ...t._def, shape: () => e });
    }
    return t instanceof ua
      ? new ua({ ...t._def, type: ha(t.element) })
      : t instanceof Ia
      ? Ia.create(ha(t.unwrap()))
      : t instanceof Pa
      ? Pa.create(ha(t.unwrap()))
      : t instanceof ya
      ? ya.create(t.items.map((t) => ha(t)))
      : t;
  }
  ua.create = (t, e) =>
    new ua({
  ...
  class da extends zo {
    ...
    _parse(t) {
      ...
      const { status: e, ctx: r } = this._processInputParams(t),
        ...
        i = [];
      if (
        !(this._def.catchall instanceof aa && "strip" === this._def.unknownKeys)
      )
        for (const t in r.data) s.includes(t) || i.push(t);
      const o = [];
      for (const t of s) {
        const e = n[t],
          s = r.data[t];
      ...
      if (this._def.catchall instanceof aa) {
        ...
        if ("passthrough" === t)
          ...
          i.length > 0 &&
            (Bo(r, { code: _o.unrecognized_keys, keys: i }), e.dirty());
        else if ("strip" !== t)
          throw new Error(
      ...
      return r.common.async
        ? Promise.resolve()
            ...
            .then((t) => Io.mergeObjectSync(e, t))
        : Io.mergeObjectSync(e, o);
    }
    get shape() {
                  ...
                  null !==
                    (i =
                      null === (s = (n = this._def).errorMap) || void 0 === s
                        ? void 0
                        : s.call(n, e, r).message) && void 0 !== i
                    ? i
                    : r.defaultError;
                return "unrecognized_keys" === e.code
                  ? {
                      message:
                        null !== (o = Zo.errToObj(t).message) && void 0 !== o
                          ? o
                          : a,
                    }
                  : { message: a };
    ...
    strip() {
      return new da({ ...this._def, unknownKeys: "strip" });
    }
    passthrough() {
      return new da({ ...this._def, unknownKeys: "passthrough" });
    }
    extend(t) {
      return new da({
        ...this._def,
    ...
    catchall(t) {
      return new da({ ...this._def, catchall: t });
    }
    pick(t) {
      const e = {};
      return (
        bo.objectKeys(t).forEach((r) => {
          t[r] && this.shape[r] && (e[r] = this.shape[r]);
        }),
        new da({ ...this._def, shape: () => e })
      );
    }
    omit(t) {
      const e = {};
      return (
        bo.objectKeys(this.shape).forEach((r) => {
    ...
    _parse(t) {
      ...
      if (e.common.async)
        return Promise.all(
          ...
          return Bo(e, { code: _o.invalid_union, unionErrors: r }), Po;
        });
      {
        let t;
        const n = [];
        for (const s of r) {
          const r = { ...e, common: { ...e.common, issues: [] }, parent: null },
            i = s._parseSync({ data: e.data, path: e.path, parent: r });
          if ("valid" === i.status) return i;
          "dirty" !== i.status || t || (t = { result: i, ctx: r }),
        ...
        return Bo(e, { code: _o.invalid_union, unionErrors: s }), Po;
      }
    }
    get options() {
  ...
  fa.create = (t, e) => new fa({ options: t, typeName: ja.ZodUnion, ...Do(e) });
  const la = (t) =>
    t instanceof _a
      ? la(t.schema)
      : t instanceof Ba
    ...
    _parse(t) {
      const { status: e, ctx: r } = this._processInputParams(t),
        n = (t, n) => {
          ...
          return s.valid
            ? ((Lo(t) || Lo(n)) && e.dirty(),
              { status: e.value, value: s.data })
            : (Bo(r, { code: _o.invalid_intersection_types }), Po);
        };
      return r.common.async
        ? Promise.all([
  ...
  ma.create = (t, e, r) =>
    new ma({ left: t, right: e, typeName: ja.ZodIntersection, ...Do(r) });
  class ya extends zo {
    _parse(t) {
      const { status: e, ctx: r } = this._processInputParams(t);
      if (r.parsedType !== vo.array)
        return (
          Bo(r, {
            code: _o.invalid_type,
            expected: vo.array,
      ...
      const n = [...r.data]
        ...
        .filter((t) => !!t);
      return r.common.async
        ? Promise.all(n).then((t) => Io.mergeArray(e, t))
        : Io.mergeArray(e, n);
    }
    get items() {
    ...
    rest(t) {
      return new ya({ ...this._def, rest: t });
    }
  }
  ya.create = (t, e) => {
    if (!Array.isArray(t))
      throw new Error("You must pass an array of schemas to z.tuple([ ... ])");
    return new ya({ items: t, typeName: ja.ZodTuple, rest: null, ...Do(e) });
  };
  class ba extends zo {
    get keySchema() {
    ...
    _parse(t) {
      ...
      return r.common.async
        ? Io.mergeObjectAsync(e, n)
        : Io.mergeObjectSync(e, n);
    }
    get element() {
      return this._def.valueType;
    }
    static create(t, e, r) {
      return new ba(
        e instanceof zo
          ? { keyType: t, valueType: e, typeName: ja.ZodRecord, ...Do(r) }
          : {
              keyType: Yo.create(),
              valueType: t,
      ...
      if (r.common.async) {
        ...
        return Promise.resolve().then(async () => {
          for (const r of i) {
            ...
            ("dirty" !== n.status && "dirty" !== s.status) || e.dirty(),
              t.set(n.value, s.value);
          }
  ...
  wa.create = (t, e, r) =>
    new wa({ valueType: e, keyType: t, typeName: ja.ZodMap, ...Do(r) });
  class va extends zo {
    _parse(t) {
      const { status: e, ctx: r } = this._processInputParams(t);
      if (r.parsedType !== vo.set)
        return (
          Bo(r, {
            code: _o.invalid_type,
            expected: vo.set,
      ...
      const o = [...r.data.values()].map((t, e) =>
        s._parse(new Ro(r, t, r.path, e))
      );
    ...
    min(t, e) {
      return new va({
        ...this._def,
        minSize: { value: t, message: Zo.toString(e) },
      });
    }
    max(t, e) {
      return new va({
        ...this._def,
        maxSize: { value: t, message: Zo.toString(e) },
      });
    }
    size(t, e) {
  ...
  class xa extends zo {
    ...
    _parse(t) {
      ...
      function r(t, r) {
        return Oo({
          ...
          issueData: { code: _o.invalid_arguments, argumentsError: r },
        });
      }
      function n(t, r) {
        return Oo({
          ...
          issueData: { code: _o.invalid_return_type, returnTypeError: r },
        });
      }
      const s = { errorMap: e.common.contextualErrorMap },
        i = e.data;
      return this._def.returns instanceof Oa
        ? Uo(async (...t) => {
            const e = new Eo([]),
    ...
    args(...t) {
      return new xa({ ...this._def, args: ya.create(t).rest(oa.create()) });
    }
    returns(t) {
      return new xa({ ...this._def, returns: t });
    }
    implement(t) {
      return this.parse(t);
    }
  ...
  _a.create = (t, e) => new _a({ getter: t, typeName: ja.ZodLazy, ...Do(e) });
  class Ea extends zo {
    _parse(t) {
  ...
  function Sa(t, e) {
    return new Aa({ values: t, typeName: ja.ZodEnum, ...Do(e) });
  }
  Ea.create = (t, e) => new Ea({ value: t, typeName: ja.ZodLiteral, ...Do(e) });
  class Aa extends zo {
    _parse(t) {
      ...
      if (-1 === this._def.values.indexOf(t.data)) {
        const e = this._getOrReturnCtx(t),
          r = this._def.values;
        return (
          Bo(e, { received: e.data, code: _o.invalid_enum_value, options: r }),
          Po
        );
      }
      return Uo(t.data);
  ...
  class ka extends zo {
    _parse(t) {
      ...
      if (-1 === e.indexOf(t.data)) {
        const t = bo.objectValues(e);
        return (
          Bo(r, { received: r.data, code: _o.invalid_enum_value, options: t }),
          Po
        );
      }
      return Uo(t.data);
  ...
  ka.create = (t, e) =>
    new ka({ values: t, typeName: ja.ZodNativeEnum, ...Do(e) });
  class Oa extends zo {
    unwrap() {
      return this._def.type;
    }
    _parse(t) {
      const { ctx: e } = this._processInputParams(t);
      if (e.parsedType !== vo.promise && !1 === e.common.async)
        return (
          Bo(e, {
            code: _o.invalid_type,
            expected: vo.promise,
  ...
  Oa.create = (t, e) => new Oa({ type: t, typeName: ja.ZodPromise, ...Do(e) });
  class Ba extends zo {
    innerType() {
      return this._def.schema;
    }
    sourceType() {
      return this._def.schema._def.typeName === ja.ZodEffects
    ...
    _parse(t) {
      ...
      if ("transform" === n.type) {
        ...
        return this._def.schema
          ...
          .then((t) =>
            No(t)
              ? Promise.resolve(n.transform(t.value, s)).then((t) => ({
                  status: e.value,
                  value: t,
                }))
              : t
  ...
  (Ba.create = (t, e, r) =>
    new Ba({ schema: t, typeName: ja.ZodEffects, effect: e, ...Do(r) })),
    (Ba.createWithPreprocess = (t, e, r) =>
      new Ba({
        schema: e,
  ...
  class Ia extends zo {
    _parse(t) {
      return this._getType(t) === vo.undefined
        ? Uo(void 0)
  ...
  Ia.create = (t, e) =>
    new Ia({ innerType: t, typeName: ja.ZodOptional, ...Do(e) });
  class Pa extends zo {
    _parse(t) {
      return this._getType(t) === vo.null
        ? Uo(null)
        : this._def.innerType._parse(t);
    }
    unwrap() {
  ...
  Pa.create = (t, e) =>
    new Pa({ innerType: t, typeName: ja.ZodNullable, ...Do(e) });
  class Ta extends zo {
    _parse(t) {
      const { ctx: e } = this._processInputParams(t);
      let r = e.data;
      return (
        e.parsedType === vo.undefined && (r = this._def.defaultValue()),
  ...
  Ca.create = (t) => new Ca({ typeName: ja.ZodNaN, ...Do(t) });
  ...
  class Ha extends zo {
    ...
    static create(t, e) {
      return new Ha({ in: t, out: e, typeName: ja.ZodPipeline });
    }
  }
  const Za = (t, e = {}, r) =>
      t
        ? ia.create().superRefine((n, s) => {
            var i, o;
            if (!t(n)) {
              const t =
                  "function" == typeof e
                ...
                a =
                  null ===
                    (o = null !== (i = t.fatal) && void 0 !== i ? i : r) ||
                  void 0 === o ||
                  o,
                c = "string" == typeof t ? { message: t } : t;
              s.addIssue({ code: "custom", ...c, fatal: a });
            }
          })
        : ia.create(),
    Ra = { object: da.lazycreate };
  var ja;
  !(function (t) {
  ...
  const Ec = _c.string().regex(/^[a-fA-F0-9]$/),
    ...
    Pc = _c.array(Ic),
    Tc = _c.object({ value: _c.union([Ac, kc]), scriptPubKey: Ic }),
    Uc = _c.object({
      txid: Sc,
      vout: Ac,
      scriptSig: Ic,
  ...
  return (
    ...
    (t.Transaction = class {
      constructor(t) {
        "string" == typeof t && (t = Lt.hex(t)),
          t instanceof Uint8Array && (t = qe.decode(t));
        const e = Cc.TxData;
      ...
      async export() {
        const { size: t, weight: e, vsize: r, hex: n } = this;
        return {
          txid: this.txid,
          hash: this.hash,
          ...this.data,
